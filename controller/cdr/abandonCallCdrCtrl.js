    ...
    var abandonCallCdrCtrl = function ($scope, $filter, $q, $timeout, cdrApiHandler, loginService, baseUrls) {
        ...
        $scope.getProcessedCDRCSVDownload = function () {
            ...
            try {
                ...
                cdrApiHandler.prepareDownloadCDRAbandonByType(startDate, endDate, $scope.agentFilter, $scope.skillFilter, null, null, $scope.custFilter, 'csv', momentTz).then(function (cdrResp)
